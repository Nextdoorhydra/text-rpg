...
void GameStartState::Update(int ch, std::string& lastCommand) {
    ...
    case 1:
        ...
        break;
    case 2:
        GameManager::GetInstance().SetCurrentState(new JobSelectionState());
        break;
    case 3:
        GameManager::GetInstance().SetCurrentState(new CharacterUpgradeState());
        break;
    case 4:
        GameManager::GetInstance().SetCurrentState(new InventoryState(false));
        break;
    case 5:
